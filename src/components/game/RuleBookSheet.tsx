          ...
          <div className="px-5 py-4 space-y-6 text-sm leading-relaxed">
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-1 text-xs text-muted-foreground">
                ...
                <li><strong>Wildcards:</strong> <strong>Golden Body</strong> matches anything for adjacency. <strong>Sky Creator</strong> is a wildcard <em>element</em> and never blocks a neighbour, but to place it you must touch another Creator or a card carrying the <strong>Sky</strong> type — same rule as every other Creator. Regular animals and Sky Creatures still need to share a type with at least one neighbour.</li>

      ...
      <div className="container mx-auto flex items-center justify-between h-16 px-4">
        ...
        {!user ? (
          <Link
            ...
            className="ml-auto md:ml-4 min-h-11 inline-flex items-center justify-center rounded-full border-2 border-primary bg-primary text-primary-foreground hover:bg-primary/90 px-3 sm:px-5 py-2 text-sm font-semibold transition-colors whitespace-nowrap shadow-sm"
          >
            Sign in
          </Link>
        ) : (
          <Link
            to="/dashboard"
            className="ml-auto md:ml-4 min-h-11 inline-flex items-center justify-center rounded-full border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground px-3 sm:px-5 py-2 text-sm font-semibold transition-colors whitespace-nowrap"
          >
            Dashboard
          </Link>
        )}

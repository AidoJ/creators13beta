...
-- One-off backfill for test3's most recent match where the bonus was
-- earned but not credited (loss + 1 bonus point).
UPDATE public.player_progress
   SET points = points + 1,
       updated_at = now()
 WHERE user_id = '92483b54-799d-493e-b643-5c1674ed86df'
   AND EXISTS (
     SELECT 1 FROM public.quiz_match_progress q
      WHERE q.match_id = '4aec626b-5ceb-4b51-bbfd-cd37bf3d646f'
        AND q.user_id = '92483b54-799d-493e-b643-5c1674ed86df'
        AND q.bonus_points_awarded = 1
   );

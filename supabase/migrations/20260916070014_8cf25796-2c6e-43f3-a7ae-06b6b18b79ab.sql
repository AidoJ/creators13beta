...
REVOKE EXECUTE ON FUNCTION public.profiling_photos_guard_minor_consent() FROM PUBLIC, anon, authenticated;

DROP TRIGGER IF EXISTS profiling_photos_guard_minor_consent ON public.profiling_photos;
CREATE TRIGGER profiling_photos_guard_minor_consent
BEFORE INSERT OR UPDATE ON public.profiling_photos
FOR EACH ROW EXECUTE FUNCTION public.profiling_photos_guard_minor_consent();
INSERT INTO email_templates (template_key, subject, description, html_body)
VALUES (
  'case_study_submitted',
  '{{practitionerName}} has submitted a case study for review',
  'Sent to the trainer when a practitioner submits a case study assessment for review. Placeholders: {{practitionerName}}, {{clientName}}, {{caseStudyTitle}}, {{viewLink}}',
  '<!DOCTYPE html>

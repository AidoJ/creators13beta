...
// Mirror of src/lib/game/rotation.ts. Edit the source file, then re-run the script.
/**
...
import { CREATOR_TYPE_COLORS } from "./cards.ts";
import { ELEMENT_COLORS } from "./elements.ts";
import type { DeckCard, Ecosystem, PlacedCard, Axial } from "./types.ts";
import { NEIGHBOUR_DIRS, keyOf, neighbours } from "./board.ts";
